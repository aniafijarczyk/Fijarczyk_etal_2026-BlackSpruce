...
df <- read.csv("14_compare_offsets.tsv", sep="\t", header=T)
dim(df)
df <- df %>% drop_na()
dim(df)
head(df)
...
png("15_plot_offset_corrs_I.png", w = 3400, h = 4000, res=300)
p2
dev.off()
...
png("15_plot_offset_corrs_II.png", w = 3400, h = 4000, res=300)
p3
dev.off()
