...
df <- read.csv("28_compare_offsets_between_climates_rda.tsv", sep="\t", header=T)
dim(df)
df <- df %>% drop_na()
dim(df)
head(df)
...
trait.labels <- c("Height", "Biomass", "DBH","Density", "BI-1980","BI-1985","BI-1990","BI-1995")
...
png("29_plot_offset_corrs_climates_rda.png", w = 3600, h = 4000, res=300)
